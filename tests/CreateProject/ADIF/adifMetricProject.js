...
export class AdifMetricProject {
  constructor(page) {
    ...
    this.metricDefaultOption = page.getByRole('option', { name: 'ADIF Métrico 1000 - Generales' });
    this.metricGeneralOption = page.getByRole('option', { name: 'ADIF Métrico 1000 - No Generales' });
  ...
  async applyMetricTemplate(configTemplateValue = 'AdifMTrico1000Mm') {
    ...
    await expect(this.listbox).toContainText('ADIF Métrico 1000 - No Generales');
