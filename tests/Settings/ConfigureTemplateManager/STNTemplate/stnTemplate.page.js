...
const defaultName = "Slovenská technická norma";
class STNTemplatePage {
  constructor(page) {
    this.page = page;
    ...
    this.templateOptionSelect = this.page.getByRole("option", {
      name: "STN - AL",
      exact: true,
    });
  ...
  async stnTemplate() {
    try {
      ...
      await this.templateOptionSelect.click();
      await this.dialogConfirmButton.click();
    } catch (error) {
      console.log("Cannot create template with STN");
    }
  }
}

export { STNTemplatePage };
