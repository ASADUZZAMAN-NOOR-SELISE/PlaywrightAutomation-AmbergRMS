...
class TwistPage {
  constructor(page) {
    ...
    this.twistBase2Input = page.locator('[name="Cant.TwistBaseLengths.1"]');
    this.twistBase3Input = page.locator('[name="Cant.TwistBaseLengths.2"]');
    ...
    this.autoCalculate = page.getByRole("radio", {
      name: "Automatically Calculated",
    });
    this.userDefined = page.getByRole("radio", {
  ...
  async autoCalculateTwistLimits() {
    await this.editConfigBtn.click();
    await expect(this.limitTable).toBeVisible();
    await this.autoCalculate.check();
    await expect(this.limitTable).not.toBeVisible();
    await this.userDefined.check();
    await expect(this.limitTable).toBeVisible();
  }
}
