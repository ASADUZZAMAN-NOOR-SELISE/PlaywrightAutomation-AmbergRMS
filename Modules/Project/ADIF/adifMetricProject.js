...
export class AdifMetricProject {
  constructor(page) {
    ...
    // In your script you clicked: getByRole('combobox', { name: 'Select Template Option ADIF M' })
    // Keep it if it's really present:
